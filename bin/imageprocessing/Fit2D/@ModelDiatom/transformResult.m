function value = transformResult( model, x, xe, data )
  ...
  elseif x(3)==x(4)
    ...
    value.o(1) = double_error( -x(5), xe(5) );
  end
  
  value.h = double_error( x(8), xe(8) );
  value.r = double_error( x(6:7), xe(6:7) );
